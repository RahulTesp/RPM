...
public class Links {
   ...
   // public static  final String BASE_URL= "https://rpm-multivital-api-v2.azurewebsites.net/api";
    ...
    public static  final String FB_TOK_DELETE= "/notification/deletefirebasetoken?Token=";
