...
struct ConversationListItem: View {
    ...
    var body: some View {
        VStack(spacing: 0) { // 1. Reduce space between HStack and VStack
            HStack(alignment: .top, spacing: 4) { // Optional: reduce spacing here
                if viewModel.muted {
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        ...
                        HStack(spacing: 2) {
                            ...
                            if convItemViewModel.unreadCount > 0 {
                                Text("\(convItemViewModel.unreadCount)")
                                    .font(.system(size: 13))
                    ...
                    .padding(.vertical, 2) // Reduces space above and below VStack
                }
            }
            .padding(.vertical, 2) // Final control over outer padding
        }
        .onAppear {
