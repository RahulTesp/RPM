                ...
                if pgmDetList.loading {
                    ...
                    ScrollView {
                        ...
                        VStack(alignment: .leading, spacing: 20) {
                            ...
                            durationSection(geometry: geometry)

                            dateSection(geometry: geometry)

                            vitalsSection(geometry: geometry)

                            careTeamSection(geometry: geometry)

                            goalsSection(geometry: geometry)
...
extension RPMProgramDetailsView {
    ...
    func durationSection(geometry: GeometryProxy) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            Text("Duration")
    ...
    // MARK: - Date Section
    func dateSection(geometry: GeometryProxy) -> some View {
        HStack(spacing: 16) {
            VStack(alignment: .leading, spacing: 8) {
                Text("Start Date")
                    .foregroundColor(Color("title1"))
    ...
    // MARK: - Vitals Section
    func vitalsSection(geometry: GeometryProxy) -> some View {
        VStack(alignment: .leading, spacing: 8) {
    ...
    // MARK: - Care Team Section
    func careTeamSection(geometry: GeometryProxy) -> some View {
    ...
    // MARK: - Goals Section
    func goalsSection(geometry: GeometryProxy) -> some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            if let goals = pgmDetList.pgmInfo?.patientProgramGoals.goalDetails {
