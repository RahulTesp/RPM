    ...
    var body: some View {
        ...
        VStack {
            ...
            //  TOAST OVERLAY SECTION
                  ...
                  .onReceive(conversationManager.$unreadCount) { newCount in
                      print("Home UI observed unreadCount update: \(newCount)")
                  }
                ...
                ScrollView(.horizontal) {
                    HStack(spacing: 10) {
                        ...
                        ForEach(chartDays.vitalsGraph7, id: \.vitalName) { item in
                            RecentVitalsScrollView(item: item , width: cardWidth)
