...
//    
    var cameraTrack: VideoTrack? {
         participant.firstAvailableVideoTrack()
     }
...
//    }
    var isCameraTrackSwitchedOff: Bool {
        participant.firstAvailableVideoTrack()?.isSwitchedOff ?? false
    }
...
//            self.participant.cameraTrack = videoTrack
//             self.participantDidChange()
//         }
//        
