...
class CallManager: NSObject, ObservableObject {
    ...
    override init() {
        ...
        print("TwilioVideoSDK.audioDevice:", TwilioVideoSDK.audioDevice ?? "nil")
    }
    ...
    func disconnect() {
        ...
        guard let callUUID = callUUID else {
            print("Error: No active call UUID found.")
            return
        }
...
extension CallManager: CXProviderDelegate {
    ...
    func provider(_ provider: CXProvider, perform action: CXStartCallAction) {
        ...
        //provider.reportOutgoingCall(with: action.callUUID, startedConnectingAt: nil)
       // roomManager.connect(roomName: action.handle.value, accessToken: videoCallAccessToken, uuid: action.callUUID)
