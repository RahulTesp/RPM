...
struct chart7DaysView: View {
    ...
    .onTapGesture {
        ...
        print("Tapped on index1: \(highlightedIndex)")
...
func getEntries3(valueSummary:[Valuev] , count : Int)->[ChartDataEntry]{
    ...
    var i = 3
   // for patientdata in valueSummary{
...
struct MultiLineChartView3v : UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> LineChartView {
        ...
        let labels = item.values?.map { $0.label } ?? []
    ...
    func addData() -> LineChartData{
        let data = LineChartData(dataSets: [
           ...
           //  , fillColor: UIColor(Color(#colorLiteral(red: 0, green: 0.8134518862, blue: 0.9959517121, alpha: 1)))
            ...
            //Unloadings Line
            //    generateLineChartDataSet(dataSetEntries: entries2, color: UIColor(Color(#colorLiteral(red: 0.003921568627, green: 0.231372549, blue: 0.431372549, alpha: 1)))
            // , fillColor: UIColor(Color(#colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1)))
            // )
        ])
        return data
    }
