...
{
    public class CPT99489 : IBilling
    {
        private readonly BillingCodes billingCode = null;
        private readonly BillingCodes billingCode487 = null;

        private readonly BillingProcess billing = null;
        private readonly string con = string.Empty;
        public string BillingCode => "99489";
        public string BillingCode487 => "99487";
        public CPT99489(string connectionString)
        {
            ...
            billingCode487 = billing.GetBillingCodeDetails(con).Where(s => s.BillingCode == BillingCode487).FirstOrDefault();
        ...
        private void AddBilledData(PatientProgramData patientProgramData, DateTime startDate, DateTime endDate, DateTime stDateTemp, DateTime NextEndDate, bool bCycleComplete, int DaysCompleted)
        {
            ...
            if (TotalReading > (billingCode487.TargetReadings * 60))
            {
                remainingREading = TotalReading - (billingCode487.TargetReadings * 60);
            }
            ...
            if (bCycleComplete)
            {
                ...
                rPMBilling.UpdatePatientBilledData(patientDailyBillingData, billingCode, stDateTemp, con);
            }
