...
{
    public class CPT99427 : IBilling
    {
        private readonly BillingCodes billingCode = null;
        private readonly BillingCodes billingCode426 = null;

        private readonly BillingProcess billing = null;
        private readonly string con = string.Empty;
        public string BillingCode => "99427";
        public string BillingCode426 => "99426";
        public CPT99427(string connectionString)
        {
            ...
            billingCode426 = billing.GetBillingCodeDetails(con).Where(s => s.BillingCode == BillingCode426).FirstOrDefault();
        ...
        private void AddBilledData(PatientProgramData patientProgramData, DateTime startDate, DateTime endDate, DateTime stDateTemp, DateTime NextEndDate, bool bCycleComplete, int DaysCompleted)
        {
            ...
            if (TotalReading > (billingCode426.TargetReadings * 60))
            {
                remainingREading = TotalReading - (billingCode426.TargetReadings * 60);
            }
            ...
            if (bCycleComplete)
            {
                ...
                RPMCycleBasedBilling.UpdatePatientBilledData(patientDailyBillingData, billingCode426, stDateTemp, con);
            }
