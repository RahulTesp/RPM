...
{
    public class CPT99457 : IBilling
    {
        ...
        public CPT99457(string connectionString)
        {
        ...
        //    }
        //    SetData(patientProgramData, TotalReading, Convert.ToDateTime(stDateTemp), billingCode.BillingCodeID, DaysCompleted, bCycleComplete, NextEndDate);
        //    if (bCycleComplete)
        //    {
